...
class AnalysisScore(object):
    ...
    def getNewsArrgs(self):
        jsonFilePath = '/Users/hansol/desktop (2)/Bubblow/nt-worker/news_aggr/new_news_aggr.json'
    ...
    def getJournalWeight(self):
        jsonFilePath = '/Users/hansol/desktop (2)/Bubblow/nt-worker/news_aggr/journal_weight.json'
        with open(jsonFilePath, 'r', encoding='utf-8') as json_file:
            journalWeightBuffer = json.load(json_file)
        return journalWeightBuffer

    def getVanillaWeight(self):
        jsonFilePath = '/Users/hansol/desktop (2)/Bubblow/nt-worker/news_aggr/vanilla_weight.json'
        with open(jsonFilePath, 'r', encoding='utf-8') as json_file:
